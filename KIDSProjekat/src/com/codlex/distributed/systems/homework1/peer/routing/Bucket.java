...
// TODO: [REWRITE] THIS CLASS TO BE SIMPLE
public class Bucket {


	/*
	 * TODO: [REWRITE] If the sending node already exists in the recipient’s k-bucket, the recipient moves it to the tail of the list.
